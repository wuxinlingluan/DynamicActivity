        ...
        mAdapter = new ClassifyDetailAdapter(mContext, mDatas, new RvListener() {
            ...
            public void onItemClick(int id, int position) {
                ...
                try {
                    ...
                    intent.setClass(getActivity(), Class.forName(mDatas.get(position).getAcitivityName()));
                    startActivity(intent);
                } catch (ClassNotFoundException e) {
                    e.printStackTrace();
                }
                Snackbar snackbar = Snackbar.make(mRv, "当前点击的是" + content + ":" + mDatas.get(position).getAcitivityName(), Snackbar.LENGTH_SHORT);
